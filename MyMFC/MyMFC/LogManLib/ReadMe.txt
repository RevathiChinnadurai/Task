========================================================================
    STATIC LIBRARY : LogManLib Project Overview
========================================================================

AppWizard has created this LogManLib library project for you.

This file contains a summary of what you will find in each of the files that
make up your LogManLib application.
...
StdAfx.h, StdAfx.cpp
    ...
    named LogManLib.pch and a precompiled types file named StdAfx.obj.
...
project, including "resource.h", "LogManLib.rc" and a "LogManLib.h" that
