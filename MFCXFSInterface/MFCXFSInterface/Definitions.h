...
typedef HRESULT(WINAPI *pfnWFMCloseKey)(HKEY hKey);
typedef HRESULT(WINAPI *pfnWFMCreateKey)(HKEY hKey, LPSTR lpszSubKey, PHKEY phkResult, LPDWORD lpdwDisposition);
typedef HRESULT(WINAPI *pfnWFMDeleteKey)(HKEY hKey, LPSTR lpszSubKey);
typedef HRESULT(WINAPI *pfnWFMDeleteValue)(HKEY hKey, LPSTR lpszValue);
typedef HRESULT(WINAPI *pfnWFMEnumKey)(HKEY hKey, DWORD iSubKey, LPSTR lpszName, LPDWORD lpcchName, PFILETIME lpftLastWrite);
typedef HRESULT(WINAPI *pfnWFMEnumValue)(HKEY hKey, DWORD iValue, LPSTR lpszValue, LPDWORD lpcchValue, LPSTR lpszData, LPDWORD lpcchData);
typedef HRESULT(WINAPI *pfnWFMOpenKey)(HKEY hKey, LPSTR lpszSubKey, PHKEY phkResult);
typedef HRESULT(WINAPI *pfnWFMQueryValue)(HKEY hKey, LPSTR lpszValueName, LPSTR lpszData, LPDWORD lpcchData);
typedef HRESULT(WINAPI *pfnWFMSetValue)(HKEY hKey, LPSTR lpszValueName, LPSTR lpszData, DWORD cchData);
#ifdef __cplusplus
}       /*extern "C"*/
#endif
